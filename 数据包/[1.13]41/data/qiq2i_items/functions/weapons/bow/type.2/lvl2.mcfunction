...
execute store result score #qiq2i_marker_1 qiq2i_1 run data get storage qiq2i_marker marker1.Motion[0] 2000
execute store result storage qiq2i_marker marker1.marker1 double 0.001 run scoreboard players get #qiq2i_marker_1 qiq2i_1
...
execute store result score #qiq2i_marker_1 qiq2i_1 run data get storage qiq2i_marker marker1.Motion[1] 2000
execute store result storage qiq2i_marker marker1.marker1 double 0.001 run scoreboard players get #qiq2i_marker_1 qiq2i_1
...
execute store result score #qiq2i_marker_1 qiq2i_1 run data get storage qiq2i_marker marker1.Motion[2] 2000
execute store result storage qiq2i_marker marker1.marker1 double 0.001 run scoreboard players get #qiq2i_marker_1 qiq2i_1
