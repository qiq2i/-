...
kill @e[nbt={Item:{components:{"minecraft:custom_data": {qiq2i_clga1_playerdead_item: 1b}}}}]
execute in qiq2i_clga1:market run loot spawn 0 1 0 loot qiq2i_clga1:dead/skull
execute in qiq2i_clga1:market positioned 0 1 0 as @e[nbt={Item:{components:{"minecraft:custom_data": {qiq2i_clga1_playerdead_item: 1b}}}},sort=nearest,limit=1] run data modify storage qiq2i_clga1_player "minecraft:profile" set from entity @s Item.components."minecraft:profile"
kill @e[nbt={Item:{components:{"minecraft:custom_data": {qiq2i_clga1_playerdead_item: 1b}}}}]
...
execute as @e[tag=qiq2i_clga1_player_dead_marker1,tag=!qiq2i_clga1_player_dead_marker1_end,sort=nearest,limit=1] run data modify entity @s ArmorItems[3].components."minecraft:profile" set from storage qiq2i_clga1_player "minecraft:profile"
execute as @e[tag=qiq2i_clga1_player_dead_marker1,tag=!qiq2i_clga1_player_dead_marker1_end,sort=nearest,limit=1] run data modify entity @s ArmorItems[3].components."minecraft:custom_data".Inventory set from storage qiq2i_clga1_player Inventory
...
execute as @e[tag=qiq2i_clga1_player_dead_marker1,tag=qiq2i_clga1_player_dead_marker1_end] unless data entity @s ArmorItems[3].components."minecraft:custom_data".Inventory[0] run kill @s
