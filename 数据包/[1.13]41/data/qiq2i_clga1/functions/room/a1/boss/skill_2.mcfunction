...
execute if score #qiq2i_clga1_rooma1_boss1_skill_2_AbsorptionAmount qiq2i_1 matches 0 run effect clear @e[tag=qiq2i_clga1_rooma1_bossa1,nbt={active_effects:[{id:"minecraft:resistance",amplifier:4b}]}] resistance