...
execute if score #qiq2i_clga1_rooma1_boss1_skill_2_AbsorptionAmount qiq2i_1 matches ..255 as @e[tag=qiq2i_clga1_rooma1_bossa1] store result entity @s ArmorItems[3].components."minecraft:enchantments".levels."minecraft:thorns" int 1 run scoreboard players get #qiq2i_clga1_rooma1_boss1_skill_2_AbsorptionAmount qiq2i_1
execute unless score #qiq2i_clga1_rooma1_boss1_skill_2_AbsorptionAmount qiq2i_1 matches ..255 as @e[tag=qiq2i_clga1_rooma1_bossa1] run data modify entity @s ArmorItems[3].components."minecraft:enchantments".levels."minecraft:thorns" set value 255
