...
execute in qiq2i_clga1:spawn store result block 0 1 0 exit_portal[0] int 1 run scoreboard players get #qiq2i_clga1_rooma1.2_pos0 qiq2i_1
execute in qiq2i_clga1:spawn store result block 0 1 0 exit_portal[1] int 1 run scoreboard players get #qiq2i_clga1_rooma1.2_pos1 qiq2i_1
execute in qiq2i_clga1:spawn store result block 0 1 0 exit_portal[2] int 1 run scoreboard players get #qiq2i_clga1_rooma1.2_pos2 qiq2i_1