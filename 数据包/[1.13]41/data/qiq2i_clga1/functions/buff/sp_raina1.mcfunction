...
execute if predicate qiq2i_clga1:qiq2i_clga1_sp_raina1_raining at @s unless biome ~ ~ ~ desert unless biome ~ ~ ~ badlands unless biome ~ ~ ~ eroded_badlands unless biome ~ ~ ~ savanna unless biome ~ ~ ~ savanna_plateau unless biome ~ ~ ~ stony_peaks unless biome ~ ~ ~ windswept_savanna unless biome ~ ~ ~ wooded_badlands if blocks ~ ~1 ~ ~ 318 ~ ~ 319 ~ masked run scoreboard players add @s qiq2i_sp_raina1 5

##小雨伞
#execute if predicate qiq2i_clga1:qiq2i_clga1_sp_raina1_raining at @s unless biome ~ ~ ~ desert unless biome ~ ~ ~ badlands unless biome ~ ~ ~ eroded_badlands unless biome ~ ~ ~ savanna unless biome ~ ~ ~ savanna_plateau unless biome ~ ~ ~ stony_peaks unless biome ~ ~ ~ windswept_savanna unless biome ~ ~ ~ wooded_badlands if data entity @s Inventory.[{Slot:-106b,components:{"minecraft:custom_data": {qiq2i_clga1_item_sp.other: {id: "umbrella.1"}}}}] if blocks ~ ~1 ~ ~ 318 ~ ~ 319 ~ masked run scoreboard players remove @s qiq2i_sp_raina1 5
execute if predicate qiq2i_clga1:qiq2i_clga1_sp_raina1_raining at @s unless biome ~ ~ ~ desert unless biome ~ ~ ~ badlands unless biome ~ ~ ~ eroded_badlands unless biome ~ ~ ~ savanna unless biome ~ ~ ~ savanna_plateau unless biome ~ ~ ~ stony_peaks unless biome ~ ~ ~ windswept_savanna unless biome ~ ~ ~ wooded_badlands if items entity @s weapon.* *[minecraft:custom_data~{qiq2i_clga1_item_sp.other: {id: "umbrella.1"}}] if blocks ~ ~1 ~ ~ 318 ~ ~ 319 ~ masked run scoreboard players remove @s qiq2i_sp_raina1 5

execute if predicate qiq2i_clga1:qiq2i_clga1_sp_raina1_raining at @s unless biome ~ ~ ~ desert unless biome ~ ~ ~ badlands unless biome ~ ~ ~ eroded_badlands unless biome ~ ~ ~ savanna unless biome ~ ~ ~ savanna_plateau unless biome ~ ~ ~ stony_peaks unless biome ~ ~ ~ windswept_savanna unless biome ~ ~ ~ wooded_badlands if data entity @s Inventory.[{Slot:103b}] if blocks ~ ~1 ~ ~ 318 ~ ~ 319 ~ masked run scoreboard players remove @s qiq2i_sp_raina1 1

execute if predicate qiq2i_clga1:qiq2i_clga1_sp_raina1_raining at @s unless biome ~ ~ ~ desert unless biome ~ ~ ~ badlands unless biome ~ ~ ~ eroded_badlands unless biome ~ ~ ~ savanna unless biome ~ ~ ~ savanna_plateau unless biome ~ ~ ~ stony_peaks unless biome ~ ~ ~ windswept_savanna unless biome ~ ~ ~ wooded_badlands if data entity @s Inventory.[{Slot:102b}] if blocks ~ ~1 ~ ~ 318 ~ ~ 319 ~ masked run scoreboard players remove @s qiq2i_sp_raina1 1

execute if predicate qiq2i_clga1:qiq2i_clga1_sp_raina1_raining at @s unless biome ~ ~ ~ desert unless biome ~ ~ ~ badlands unless biome ~ ~ ~ eroded_badlands unless biome ~ ~ ~ savanna unless biome ~ ~ ~ savanna_plateau unless biome ~ ~ ~ stony_peaks unless biome ~ ~ ~ windswept_savanna unless biome ~ ~ ~ wooded_badlands if data entity @s Inventory.[{Slot:101b}] if blocks ~ ~1 ~ ~ 318 ~ ~ 319 ~ masked run scoreboard players remove @s qiq2i_sp_raina1 1

execute if predicate qiq2i_clga1:qiq2i_clga1_sp_raina1_raining at @s unless biome ~ ~ ~ desert unless biome ~ ~ ~ badlands unless biome ~ ~ ~ eroded_badlands unless biome ~ ~ ~ savanna unless biome ~ ~ ~ savanna_plateau unless biome ~ ~ ~ stony_peaks unless biome ~ ~ ~ windswept_savanna unless biome ~ ~ ~ wooded_badlands if data entity @s Inventory.[{Slot:100b}] if blocks ~ ~1 ~ ~ 318 ~ ~ 319 ~ masked run scoreboard players remove @s qiq2i_sp_raina1 1
...
execute at @s if biome ~ ~ ~ desert run scoreboard players remove @s[scores={qiq2i_sp_raina1=1..}] qiq2i_sp_raina1 10
execute at @s if biome ~ ~ ~ badlands run scoreboard players remove @s[scores={qiq2i_sp_raina1=1..}] qiq2i_sp_raina1 10
execute at @s if biome ~ ~ ~ eroded_badlands run scoreboard players remove @s[scores={qiq2i_sp_raina1=1..}] qiq2i_sp_raina1 10
execute at @s if biome ~ ~ ~ savanna run scoreboard players remove @s[scores={qiq2i_sp_raina1=1..}] qiq2i_sp_raina1 10
execute at @s if biome ~ ~ ~ savanna_plateau run scoreboard players remove @s[scores={qiq2i_sp_raina1=1..}] qiq2i_sp_raina1 10
execute at @s if biome ~ ~ ~ stony_peaks run scoreboard players remove @s[scores={qiq2i_sp_raina1=1..}] qiq2i_sp_raina1 10
execute at @s if biome ~ ~ ~ windswept_savanna run scoreboard players remove @s[scores={qiq2i_sp_raina1=1..}] qiq2i_sp_raina1 10
execute at @s if biome ~ ~ ~ wooded_badlands run scoreboard players remove @s[scores={qiq2i_sp_raina1=1..}] qiq2i_sp_raina1 10
...
execute if predicate qiq2i_clga1:qiq2i_clga1_sp_raina1_raining unless biome ~ ~ ~ desert as @s[scores={qiq2i_sp_raina1=4000}] at @s if blocks ~ ~1 ~ ~ 318 ~ ~ 319 ~ masked run tellraw @s {"text":"","extra":[{"text":"§e你现在湿漉漉的！快避雨！"}]}
