...
summon arrow ~ ~ ~ {Tags:["qiq2i_clga1_buff_sp_ender_dragona1_arrow","qiq2i_arrow.kill"],damage:4}
...
data modify entity @e[tag=qiq2i_clga1_buff_sp_ender_dragona1_arrow,distance=..5,limit=1,sort=nearest] item.components."minecraft:potion_contents" set from entity @s HandItems[1].components."minecraft:potion_contents"
