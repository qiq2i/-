...
execute at @e[type=#qiq2i_clga1:friend,tag=!qiq2i_admin,distance=..16] run particle block{block_state: "snow_block"} ~ ~1 ~ 0.1 1 0.1 0 100
particle block{block_state: "snow_block"} ~ ~1 ~ 0.1 1 0.1 0 100
