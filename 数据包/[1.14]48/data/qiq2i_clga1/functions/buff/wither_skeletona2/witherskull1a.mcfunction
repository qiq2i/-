...
execute as @e[tag=qiq2i_skill_1_witherskull1a,distance=..5,limit=1,sort=nearest] store result entity @e[tag=qiq2i_skill_1_witherskull1a_2,distance=..5,limit=1,sort=nearest] power[0] double 0.001 run scoreboard players get @s qiq2i_2
#1
...
execute as @e[tag=qiq2i_skill_1_witherskull1a,distance=..5,limit=1,sort=nearest] run scoreboard players operation @s qiq2i_2 -= @s qiq2i_1
execute as @e[tag=qiq2i_skill_1_witherskull1a,distance=..5,limit=1,sort=nearest] store result entity @e[tag=qiq2i_skill_1_witherskull1a_2,distance=..5,limit=1,sort=nearest] power[1] double 0.001 run scoreboard players get @s qiq2i_2
#2
...
execute as @e[tag=qiq2i_skill_1_witherskull1a,distance=..5,limit=1,sort=nearest] run scoreboard players operation @s qiq2i_2 -= @s qiq2i_1
execute as @e[tag=qiq2i_skill_1_witherskull1a,distance=..5,limit=1,sort=nearest] store result entity @e[tag=qiq2i_skill_1_witherskull1a_2,distance=..5,limit=1,sort=nearest] power[2] double 0.001 run scoreboard players get @s qiq2i_2
