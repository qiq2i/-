...
execute if score #qiq2i_clga1_rooma1.2_skill.c4 qiq2i_1 matches 1 as @e[tag=qiq2i_clga1_rooma1.2_bossa1] run item replace entity @s weapon.mainhand with bow[minecraft:enchantments={levels: {"minecraft:power": 5, "minecraft:flame": 1}}]
