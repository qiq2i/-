...
function qiq2i_clga1:command/showbuff/a2
data remove storage qiq2i_clga1_event_new qiq2i_clga1_buff_show_list2
execute if data storage qiq2i_clga1_event_new qiq2i_clga1_buff_show_list1[-1] run function qiq2i_clga1:command/showbuff/a1
