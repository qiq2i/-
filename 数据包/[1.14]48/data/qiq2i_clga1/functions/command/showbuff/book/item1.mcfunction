...
execute as @e[nbt={Item:{components:{"minecraft:custom_data": {qiq2i_clga1_command_item1: 1b, qiq2i_clga1_command_item1_start: 1b}}}}] run data modify entity @s Item.components."minecraft:custom_data".qiq2i_clga1_command_item1_start set value 2