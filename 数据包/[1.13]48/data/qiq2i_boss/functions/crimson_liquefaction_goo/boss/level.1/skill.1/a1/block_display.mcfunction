...
execute if score @s qiq2i_1 matches 80 positioned ~0.5 ~ ~0.5 run particle block{block_state: {Name: "slime_block"}} ~ ~ ~ 0.7 0.7 0.7 0 100
execute if score @s qiq2i_1 matches 100 positioned ~0.5 ~ ~0.5 run particle block{block_state: {Name: "slime_block"}} ~ ~ ~ 1 1 1 0 200
