...
data modify entity @e[tag=qiq2i_clga1_buff_skeletona4_arrow,distance=..5,limit=1,sort=nearest] item.components."minecraft:potion_contents" set from entity @s HandItems[1].components."minecraft:potion_contents"
...
execute store result entity @s Motion[0] double 0.09 run scoreboard players get #qiq2i_marker_1.1 qiq2i_1
execute store result entity @s Motion[1] double 0.09 run scoreboard players get #qiq2i_marker_2.1 qiq2i_1
execute store result entity @s Motion[2] double 0.09 run scoreboard players get #qiq2i_marker_3.1 qiq2i_1
