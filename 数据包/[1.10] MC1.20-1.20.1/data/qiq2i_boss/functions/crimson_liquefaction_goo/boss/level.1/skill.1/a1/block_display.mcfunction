...
execute if score @s qiq2i_1 matches 100.. positioned ~0.5 ~ ~0.5 as @e[distance=..3,type=!slime,tag=!qiq2i_admin] run damage @s 10 minecraft:explosion by @e[type=slime,tag=qiq2i_boss.crimson_liquefaction_goo.1,limit=1,sort=nearest]
