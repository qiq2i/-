...
execute if score @s qiq2i_1 matches 1 run particle block slime_block ~ ~ ~ 0.5 0.5 0.5 1 10
...
execute if score @s qiq2i_1 matches 1..60 positioned ~-0.5 ~0.5 ~-0.5 run particle dust 0 1 0.149 10 ~ ~ ~ 0 0.5 0 0 1
execute if score @s qiq2i_1 matches 1..60 positioned ~0.5 ~0.5 ~-0.5 run particle dust 0 1 0.149 10 ~ ~ ~ 0 0.5 0 0 1
execute if score @s qiq2i_1 matches 1..60 positioned ~-0.5 ~0.5 ~0.5 run particle dust 0 1 0.149 10 ~ ~ ~ 0 0.5 0 0 1
execute if score @s qiq2i_1 matches 1..60 positioned ~0.5 ~0.5 ~0.5 run particle dust 0 1 0.149 10 ~ ~ ~ 0 0.5 0 0 1
execute if score @s qiq2i_1 matches 1..60 positioned ~ ~1.5 ~ run particle dust 0 1 0.149 10 ~ ~ ~ 0.5 0 0.5 0 1
