...
execute if score @s qiq2i_1 matches 1..60 positioned ~-0.5 ~0.5 ~-0.5 run particle dust{color:[0.0,1.0,0.149], scale:3} ~ ~ ~ 0 0.5 0 0 1
execute if score @s qiq2i_1 matches 1..60 positioned ~0.5 ~0.5 ~-0.5 run particle dust{color:[0.0,1.0,0.149], scale:3} ~ ~ ~ 0 0.5 0 0 1
execute if score @s qiq2i_1 matches 1..60 positioned ~-0.5 ~0.5 ~0.5 run particle dust{color:[0.0,1.0,0.149], scale:3} ~ ~ ~ 0 0.5 0 0 1
execute if score @s qiq2i_1 matches 1..60 positioned ~0.5 ~0.5 ~0.5 run particle dust{color:[0.0,1.0,0.149], scale:3} ~ ~ ~ 0 0.5 0 0 1
execute if score @s qiq2i_1 matches 1..60 positioned ~ ~1.5 ~ run particle dust{color:[0.0,1.0,0.149], scale:3} ~ ~ ~ 0 0.5 0 0 1
