...
tag @s add qiq2i_boss.crimson_liquefaction_goo.1_level.1.a1
data modify entity @s CustomName set value '{"text":"§a赤炼凝胶"}'
bossbar remove qiq2i_boss.crimson_liquefaction_goo.1
bossbar add qiq2i_boss.crimson_liquefaction_goo.1 "§a赤炼凝胶"
bossbar set qiq2i_boss.crimson_liquefaction_goo.1 color green
