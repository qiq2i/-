...
execute as @e[tag=qiq2i_boss.drowned_knight.summon.1] run item replace entity @s armor.head with leather_helmet{Enchantments:[],display:{color:48127}}
execute as @e[tag=qiq2i_boss.drowned_knight.summon.1] run item replace entity @s armor.feet with leather_boots{Enchantments:[{id:"minecraft:depth_strider",lvl:5}],display:{color:48127}}
