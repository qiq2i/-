...
##
execute if score #qiq2i_clga1_item_enchat_marker1 qiq2i_1 matches 1..10 if score #qiq2i_clga1_item_enchat_marker2 qiq2i_1 matches 1 if data entity @s Inventory[{Slot:-106b,count:1}] run function qiq2i_items:enchat/type_12/main
