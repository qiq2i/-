...
##
execute if score #qiq2i_clga1_item_enchat_marker1 qiq2i_1 matches 1..4 if data entity @s Inventory[{Slot:-106b,count:1}] run function qiq2i_items:enchat/type_8/main
