...
execute as @s[tag=qiq2i_clga1_sp_pillagera7_Mobs1_start,scores={qiq2i_1=1060}] at @s run summon item_frame ~ ~ ~ {Item:{id:"minecraft:carrot_on_a_stick",Count:1,tag:{CustomModelData:2002030}},Facing:1b,Invisible:1b,Fixed:1b,Invulnerable:1b,Tags:["qiq2i_clga1_buff_sp_pillagera7_item_frame"]}
