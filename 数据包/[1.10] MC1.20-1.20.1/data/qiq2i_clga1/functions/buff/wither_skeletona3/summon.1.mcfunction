summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["qiq2i_clga1_buff_wither_skeletona3.summon.1"],Color:0,Duration:80,Radius:1,effects:[{id:20,duration:200,amplifier:0}]}
