...
execute as @s[nbt=!{Health:300f},scores={qiq2i_1=1..4}] at @s run summon vindicator ~ ~ ~ {Tags:["qiq2i_clga1_sp_pillagera5_Mobs3"],PatrolLeader:1,HandItems:[{id:"netherite_axe",count:1,components:{"minecraft:enchantments": {levels: {"minecraft:sharpness": 5s, "minecraft:knockback": 2s, "minecraft:fire_aspect": 3s, "minecraft:looting": 3s, "minecraft:sweeping": 3s, "minecraft:unbreaking": 3s, "minecraft:efficiency": 5s, "minecraft:fortune": 3s, "minecraft:mending": 1s}}}},{}],ArmorItems:[{},{},{},{}],ArmorDropChances:[0.0F,0.0F,0.0F,0.0F],HandDropChances:[0.0f,0.0f],CanJoinRaid:1}
