...
summon arrow ~ ~ ~ {Tags:["qiq2i_clga1_buff_zombiea3_arrow","qiq2i_arrow_kill1","qiq2i_arrow.kill"],damage:6}
...
#0
execute store result score #qiq2i_marker_1 qiq2i_1 run data get entity @e[tag=qiq2i_clga1_buff_zombiea3_arrow,limit=1,sort=nearest,distance=..1] Pos[0] 100
execute store result score #qiq2i_marker_2 qiq2i_1 run data get entity @e[tag=qiq2i_clga1_buff_zombiea3_arrow,limit=1,sort=nearest,distance=..1] Pos[1] 100
execute store result score #qiq2i_marker_3 qiq2i_1 run data get entity @e[tag=qiq2i_clga1_buff_zombiea3_arrow,limit=1,sort=nearest,distance=..1] Pos[2] 100
...
execute store result entity @e[tag=qiq2i_clga1_buff_zombiea3_arrow,limit=1,sort=nearest,distance=..1] Motion[0] double 0.016 run scoreboard players get #qiq2i_marker_1.1 qiq2i_1
execute store result entity @e[tag=qiq2i_clga1_buff_zombiea3_arrow,limit=1,sort=nearest,distance=..1] Motion[1] double 0.016 run scoreboard players get #qiq2i_marker_2.1 qiq2i_1
execute store result entity @e[tag=qiq2i_clga1_buff_zombiea3_arrow,limit=1,sort=nearest,distance=..1] Motion[2] double 0.016 run scoreboard players get #qiq2i_marker_3.1 qiq2i_1
...
tag @e[tag=qiq2i_clga1_buff_zombiea3_arrow] remove qiq2i_clga1_buff_zombiea3_arrow
