tag @s add qiq2i_clga1_buff_villager.b13_level.4
...
data modify entity @s Offers.Recipes[-1].sell.tag.StoredEnchantments set from entity @e[type=item,nbt={Item:{tag:{qiq2i_clga1_buff_item_enchanting:1}}},limit=1,sort=nearest] Item.tag.Enchantments
