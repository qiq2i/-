...
summon arrow ~ ~ ~ {Tags:["qiq2i","qiq2i_skill_1","qiq2i_skill_1_arrow1_pillagera5_a_2"],damage:4}
#0
...
execute as @e[tag=qiq2i_skill_1_arrow1_pillagera5_a,distance=..3,limit=1,sort=nearest] store result entity @e[tag=qiq2i_skill_1_arrow1_pillagera5_a_2,distance=..3,limit=1,sort=nearest] Motion[0] double 0.03 run scoreboard players get @s qiq2i_2
#1
...
execute as @e[tag=qiq2i_skill_1_arrow1_pillagera5_a,distance=..3,limit=1,sort=nearest] run scoreboard players operation @s qiq2i_2 -= @s qiq2i_1
execute as @e[tag=qiq2i_skill_1_arrow1_pillagera5_a,distance=..3,limit=1,sort=nearest] store result entity @e[tag=qiq2i_skill_1_arrow1_pillagera5_a_2,distance=..3,limit=1,sort=nearest] Motion[1] double 0.03 run scoreboard players get @s qiq2i_2
#2
...
execute as @e[tag=qiq2i_skill_1_arrow1_pillagera5_a,distance=..3,limit=1,sort=nearest] run scoreboard players operation @s qiq2i_2 -= @s qiq2i_1
execute as @e[tag=qiq2i_skill_1_arrow1_pillagera5_a,distance=..3,limit=1,sort=nearest] store result entity @e[tag=qiq2i_skill_1_arrow1_pillagera5_a_2,distance=..3,limit=1,sort=nearest] Motion[2] double 0.03 run scoreboard players get @s qiq2i_2
