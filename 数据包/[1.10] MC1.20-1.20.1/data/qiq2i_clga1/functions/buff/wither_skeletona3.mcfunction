...
item replace entity @s weapon.offhand with lingering_potion[minecraft:custom_data={custom_potion_effects: [{id: "minecraft:wither", amplifier: 0, duration: 200}], CustomPotionColor: 0}]