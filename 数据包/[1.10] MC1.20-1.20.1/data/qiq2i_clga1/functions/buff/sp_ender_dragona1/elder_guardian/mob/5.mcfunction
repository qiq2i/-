...
execute as @s unless data entity @s ArmorItems[2].id run item replace entity @s armor.chest with leather_chestplate{Enchantments:[{id:"minecraft:thorns",lvl:20}]}