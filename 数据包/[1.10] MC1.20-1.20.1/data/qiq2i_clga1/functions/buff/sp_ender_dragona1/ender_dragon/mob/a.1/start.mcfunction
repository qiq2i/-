...
item replace entity @s armor.head with leather_helmet{display:{color:16711901}} 1
item replace entity @s armor.chest with leather_chestplate{display:{color:16711901}} 1
item replace entity @s weapon.mainhand with iron_sword 1
execute if predicate qiq2i_clga1:_0.5 run item replace entity @s weapon.mainhand with bow{Enchantments:[{id:"minecraft:power",lvl:1}]} 1
