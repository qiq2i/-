...
summon arrow ~ ~ ~ {Tags:["qiq2i_clga1_buff_sp_ender_dragona1_arrow","qiq2i_clga1_buff_sp_ender_dragona1_arrow.kill","qiq2i_clga1_kill.a1"],damage:4}
...
execute store result entity @e[tag=qiq2i_clga1_buff_sp_ender_dragona1_arrow,limit=1,sort=nearest,distance=..1] Motion[0] double 0.032 run scoreboard players get #qiq2i_marker_1.1 qiq2i_1
execute store result entity @e[tag=qiq2i_clga1_buff_sp_ender_dragona1_arrow,limit=1,sort=nearest,distance=..1] Motion[1] double 0.032 run scoreboard players get #qiq2i_marker_2.1 qiq2i_1
execute store result entity @e[tag=qiq2i_clga1_buff_sp_ender_dragona1_arrow,limit=1,sort=nearest,distance=..1] Motion[2] double 0.032 run scoreboard players get #qiq2i_marker_3.1 qiq2i_1
