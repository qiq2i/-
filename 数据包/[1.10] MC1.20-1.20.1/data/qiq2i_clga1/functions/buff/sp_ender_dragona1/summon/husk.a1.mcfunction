...
execute as @e[tag=qiq2i_clga1_sp_ender_dragona1_husk.a_set] run item replace entity @s armor.head with leather_helmet{Enchantments:[{id:"minecraft:unbreaking",lvl:3}],display:{color:16716306}}
