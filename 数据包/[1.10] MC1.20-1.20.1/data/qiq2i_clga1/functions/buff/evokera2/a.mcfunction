...
execute if score @s qiq2i_1 matches 6 run particle block{block_state: "cactus"} ~ ~1 ~ 0.1 1 0.1 0 100
execute if score @s qiq2i_1 matches 6 at @e[type=#qiq2i_clga1:friend,tag=!qiq2i_admin,distance=..16] run particle block{block_state: "cactus"} ~ ~1 ~ 0.1 1 0.1 0 100
execute if score @s qiq2i_1 matches 6 run playsound minecraft:block.note_block.didgeridoo ambient @a ~ ~ ~ 3 1
execute if score @s qiq2i_1 matches 7 run particle block{block_state: "cactus"} ~ ~1 ~ 0.1 1 0.1 0 100
execute if score @s qiq2i_1 matches 7 at @e[type=#qiq2i_clga1:friend,tag=!qiq2i_admin,distance=..16] run particle block{block_state: "cactus"} ~ ~1 ~ 0.1 1 0.1 0 100
