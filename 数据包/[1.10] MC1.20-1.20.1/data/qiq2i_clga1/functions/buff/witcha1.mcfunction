...
execute as @e[type=witch,tag=qiq2i_clga1_buff_witcha1,scores={qiq2i_1=8}] at @s positioned ~ ~1.7 ~ if predicate qiq2i_clga1:_0.5 if entity @e[type=#qiq2i_clga1:friend,distance=..8] unless entity @s[nbt={Health:26f}] facing entity @e[type=#qiq2i_clga1:friend,type=!#qiq2i_clga1:animal,tag=!qiq2i_admin,sort=nearest,limit=1] eyes run function qiq2i_clga1:qiq2i_skill/skill/potion_strong_harminga1
execute as @e[type=witch,tag=qiq2i_clga1_buff_witcha1,scores={qiq2i_1=8..}] run scoreboard players set @s qiq2i_1 0