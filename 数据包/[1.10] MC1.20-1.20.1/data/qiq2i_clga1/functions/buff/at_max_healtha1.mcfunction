...
execute if data storage qiq2i_clga1_event buff.qiq2i_clga1_at_max_healtha1{level:1} run attribute @s generic.max_health modifier add 20020221-1-1-1-1001 "max_healtha1" 0.3 add_multiplied_base
execute if data storage qiq2i_clga1_event buff.qiq2i_clga1_at_max_healtha1{level:2} run attribute @s generic.max_health modifier add 20020221-1-1-1-1001 "max_healtha1" 0.6 add_multiplied_base
execute if data storage qiq2i_clga1_event buff.qiq2i_clga1_at_max_healtha1{level:3} run attribute @s generic.max_health modifier add 20020221-1-1-1-1001 "max_healtha1" 0.9 add_multiplied_base
