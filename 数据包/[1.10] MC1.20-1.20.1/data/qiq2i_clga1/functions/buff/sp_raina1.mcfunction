...
##小雨伞
execute if predicate qiq2i_clga1:qiq2i_clga1_sp_raina1_raining at @s unless predicate qiq2i_clga1:in_desert unless predicate qiq2i_clga1:in_badlands unless predicate qiq2i_clga1:in_eroded_badlands unless predicate qiq2i_clga1:in_savanna unless predicate qiq2i_clga1:in_savanna_plateau unless predicate qiq2i_clga1:in_stony_peaks unless predicate qiq2i_clga1:in_windswept_savanna unless predicate qiq2i_clga1:in_wooded_badlands if data entity @s Inventory.[{Slot:-106b,components:{"minecraft:custom_data": {qiq2i_clga1_item_sp.other: {id: "umbrella.1"}}}}] if blocks ~ ~1 ~ ~ 318 ~ ~ 319 ~ masked run scoreboard players remove @s qiq2i_sp_raina1 5
execute if predicate qiq2i_clga1:qiq2i_clga1_sp_raina1_raining at @s unless predicate qiq2i_clga1:in_desert unless predicate qiq2i_clga1:in_badlands unless predicate qiq2i_clga1:in_eroded_badlands unless predicate qiq2i_clga1:in_savanna unless predicate qiq2i_clga1:in_savanna_plateau unless predicate qiq2i_clga1:in_stony_peaks unless predicate qiq2i_clga1:in_windswept_savanna unless predicate qiq2i_clga1:in_wooded_badlands if data entity @s SelectedItem{components:{"minecraft:custom_data": {qiq2i_clga1_item_sp.other: {id: "umbrella.1"}}}} if blocks ~ ~1 ~ ~ 318 ~ ~ 319 ~ masked run scoreboard players remove @s qiq2i_sp_raina1 5
