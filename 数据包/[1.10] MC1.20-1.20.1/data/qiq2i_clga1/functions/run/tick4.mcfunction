...
execute if data storage qiq2i_clga1_event buff.qiq2i_clga1_creepera2 as @e[type=creeper,tag=!qiq2i_clga1_ignore] at @s run function qiq2i_clga1:buff/creepera2
