...
execute if data storage qiq2i_clga1_event buff.qiq2i_clga1_creepera2 if entity @e[type=creeper] as @e[type=creeper] run function qiq2i_clga1:buff/creepera2
