...
data modify storage qiq2i_clga1_event_new written_book.tag1.pages prepend value '{"text":"","extra":[{"text":"§0§l["},{"nbt":"buff[{id:at_follow_range}].level.1[0]","storage":"qiq2i_clga1:text"},{"text":"§0§l]"},{"nbt":"buff[{id:at_follow_range}].level.1[1]","storage":"qiq2i_clga1:text"},{"text":"\\n"},{"nbt":"buff[{id:at_follow_range}].level.1[2]","storage":"qiq2i_clga1:text"}]}'
