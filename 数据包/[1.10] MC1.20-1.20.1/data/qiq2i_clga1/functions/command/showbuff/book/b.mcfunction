...
data modify storage qiq2i_clga1_event_new written_book.components1.qiq2i_clga1_command_item1 set value 1
data modify storage qiq2i_clga1_event_new written_book.components1.qiq2i_clga1_command_item1_start set value 2
