...
execute store result entity @s Motion[0] double 0.048 run scoreboard players get #qiq2i_marker_1.1 qiq2i_1
execute store result entity @s Motion[1] double 0.048 run scoreboard players get #qiq2i_marker_2.1 qiq2i_1
execute store result entity @s Motion[2] double 0.048 run scoreboard players get #qiq2i_marker_3.1 qiq2i_1
