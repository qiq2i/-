...
execute as @e[tag=qiq2i_clga1_player_dead_marker1_end_2] if data entity @s ArmorItems[3].tag.Inventory[0] run function qiq2i_clga1:player_dead/inventory/inventoryitem_2
kill @e[tag=qiq2i_clga1_player_dead_marker1_end_2]