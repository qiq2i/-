...
summon arrow ~ ~ ~ {Tags:["qiq2i","qiq2i_skill_1","qiq2i_skill_1_arrow1a_2"],damage:6,Fire:1800}
#0
...
execute positioned ~ ~ ~ positioned ^1 ^ ^ run summon arrow ~ ~ ~ {Tags:["qiq2i","qiq2i_skill_1","qiq2i_skill_1_arrow1a_3"],damage:5,Fire:1800}
