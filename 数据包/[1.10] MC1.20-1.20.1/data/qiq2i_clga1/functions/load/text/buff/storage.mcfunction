...
#tellraw @a [{"nbt":"buff[{id:at_follow_range}].level.1[1]","storage":"qiq2i_clga1:text","color": "gold"},{"text":"§7\n"},{"nbt":"buff[{id:at_follow_range}].level.1[2]","storage":"qiq2i_clga1:text","color": "yellow"}]
...
data modify storage qiq2i_clga1:text buff append value {id:ghasta2,level:{1:["§a恶魂专业版 §e§lI§8§lI","",""],2:["§a恶魂专业版 §e§lII","恶魂的火焰弹威力得到提升。","专业版的恶魂会给玩家带来何种感受呢？"]}}
