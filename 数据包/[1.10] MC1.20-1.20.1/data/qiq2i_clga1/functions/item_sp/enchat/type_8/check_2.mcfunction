...
##
execute if score #qiq2i_clga1_item_enchat_marker1 qiq2i_1 matches 1..8 if score #qiq2i_clga1_item_enchat_marker2 qiq2i_1 matches 1 if data entity @s Inventory[{Slot:-106b,Count:1b}] run tellraw @s {"text":"","extra":[{"text":"§e爆炸保护宝石II §a使用成功"}]}
##
execute if score #qiq2i_clga1_item_enchat_marker1 qiq2i_1 matches 1..8 if score #qiq2i_clga1_item_enchat_marker2 qiq2i_1 matches 1 if data entity @s Inventory[{Slot:-106b,Count:1b}] run clear @s emerald{qiq2i_clga1_item_enchat_type:8,qiq2i_clga1_item_enchat_type_level:2} 1
...
##
execute if score #qiq2i_clga1_item_enchat_marker1 qiq2i_1 matches 1..8 if score #qiq2i_clga1_item_enchat_marker2 qiq2i_1 matches 1 if data entity @s Inventory[{Slot:-106b,Count:1b}] run function qiq2i_clga1:item_sp/enchat/type_8/main
