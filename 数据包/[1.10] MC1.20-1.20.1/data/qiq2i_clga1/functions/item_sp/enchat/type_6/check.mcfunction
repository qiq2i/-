...
##
execute if score #qiq2i_clga1_item_enchat_marker1 qiq2i_1 matches 1..4 if data entity @s Inventory[{Slot:-106b,Count:1b}] run clear @s emerald{qiq2i_clga1_item_enchat_type:6,qiq2i_clga1_item_enchat_type_level:1} 1
...
##
execute if score #qiq2i_clga1_item_enchat_marker1 qiq2i_1 matches 1..4 if data entity @s Inventory[{Slot:-106b,Count:1b}] run function qiq2i_clga1:item_sp/enchat/type_6/main
