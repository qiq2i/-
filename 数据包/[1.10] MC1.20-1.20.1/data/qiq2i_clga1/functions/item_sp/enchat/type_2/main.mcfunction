...
execute in qiq2i_clga1:market positioned 0 1 0 store result block ~ ~ ~ Items[0].tag.Enchantments[{id:"minecraft:protection"}].lvl int 1 run scoreboard players get #qiq2i_clga1_item_enchat_marker1 qiq2i_1
