...
execute in qiq2i_clga1:market positioned 0 1 0 run data modify block ~ ~ ~ Items[0].tag.RepairCost set value 0
item replace entity @s weapon.offhand with air
execute in qiq2i_clga1:market positioned 0 1 0 run loot replace entity @s weapon.offhand 1 mine ~ ~ ~ minecraft:diamond_pickaxe{qiq2i_clga1_tool_marker1:1b}
