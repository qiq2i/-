...
summon arrow ^-1 ^ ^ {Tags:["qiq2i_clga1_item_bow_a1.1","qiq2i_arrow_kill1"]}
summon arrow ^-2 ^ ^ {Tags:["qiq2i_clga1_item_bow_a1.1","qiq2i_arrow_kill1"]}
summon arrow ^-3 ^ ^ {Tags:["qiq2i_clga1_item_bow_a1.1","qiq2i_arrow_kill1"]}
summon arrow ^-4 ^ ^ {Tags:["qiq2i_clga1_item_bow_a1.1","qiq2i_arrow_kill1"]}
summon arrow ^1 ^ ^ {Tags:["qiq2i_clga1_item_bow_a1.1","qiq2i_arrow_kill1"]}
summon arrow ^2 ^ ^ {Tags:["qiq2i_clga1_item_bow_a1.1","qiq2i_arrow_kill1"]}
summon arrow ^3 ^ ^ {Tags:["qiq2i_clga1_item_bow_a1.1","qiq2i_arrow_kill1"]}
summon arrow ^4 ^ ^ {Tags:["qiq2i_clga1_item_bow_a1.1","qiq2i_arrow_kill1"]}
