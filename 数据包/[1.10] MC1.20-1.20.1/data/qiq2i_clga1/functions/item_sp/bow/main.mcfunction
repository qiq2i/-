...
execute if items entity @s weapon.* *[minecraft:custom_data~{qiq2i_clga1_item_bow.1: 8b}] if score @s qiq2i_bow matches 1.. at @s positioned ~ ~1.75 ~ run function qiq2i_clga1:item_sp/bow/type.1/lvl8
...
execute if items entity @s weapon.* *[minecraft:custom_data~{qiq2i_clga1_item_bow.1: 4b}] if score @s qiq2i_bow matches 1.. at @s positioned ~ ~1.75 ~ run function qiq2i_clga1:item_sp/bow/type.1/lvl4
...
execute if items entity @s weapon.* *[minecraft:custom_data~{qiq2i_clga1_item_bow.2: 1b}] if score @s qiq2i_bow matches 1.. at @s positioned ~ ~1.75 ~ run function qiq2i_clga1:item_sp/bow/type.2/lvl1
...
execute if items entity @s weapon.* *[minecraft:custom_data~{qiq2i_clga1_item_bow.2: 2b}] if score @s qiq2i_bow matches 1.. at @s positioned ~ ~1.75 ~ run function qiq2i_clga1:item_sp/bow/type.2/lvl2
...
execute if items entity @s weapon.* *[minecraft:custom_data~{qiq2i_clga1_item_bow.2: 3b}] if score @s qiq2i_bow matches 1.. at @s positioned ~ ~1.75 ~ run function qiq2i_clga1:item_sp/bow/type.2/lvl3
...
execute if items entity @s weapon.* *[minecraft:custom_data~{qiq2i_clga1_item_bow.3: 1b}] if score @s qiq2i_bow matches 1.. at @s positioned ~ ~1.75 ~ run function qiq2i_clga1:item_sp/bow/type.2/lvl3
