...
execute as @e[tag=qiq2i_clga1_rooma1_bossa1] store result entity @s ArmorItems[3].tag.Enchantments[{id:"minecraft:thorns"}].lvl int 1 run scoreboard players get #qiq2i_clga1_rooma1_boss1_skill_2_AbsorptionAmount qiq2i_1
