...
execute in qiq2i_clga1:spawn store result block 0 1 0 ExitPortal.X float 1 run scoreboard players get #qiq2i_clga1_rooma1_pos0 qiq2i_1
execute in qiq2i_clga1:spawn store result block 0 1 0 ExitPortal.Y float 1 run scoreboard players get #qiq2i_clga1_rooma1_pos1 qiq2i_1
execute in qiq2i_clga1:spawn store result block 0 1 0 ExitPortal.Z float 1 run scoreboard players get #qiq2i_clga1_rooma1_pos2 qiq2i_1