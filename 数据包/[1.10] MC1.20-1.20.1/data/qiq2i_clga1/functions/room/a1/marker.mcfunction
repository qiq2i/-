##qiq2i_clga1_rooma1_marker
##summon marker ~ ~ ~ {Tags:["qiq2i_clga1_rooma1_marker"]}
...
execute if score @s qiq2i_1 matches 321.. unless score #qiq2i_clga1_rooma1_tick1 qiq2i_1 matches 1.. run kill @s