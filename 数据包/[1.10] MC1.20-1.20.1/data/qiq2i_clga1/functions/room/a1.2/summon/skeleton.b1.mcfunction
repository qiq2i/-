summon skeleton ~ ~ ~ {Tags:["qiq2i_clga1_rooma1.2_skeleton.b","qiq2i_clga1_rooma1.2_skeleton.b_set","qiq2i_clga1_ignore","qiq2i_clga1_rooma1.2_skeleton_mob"],HandItems:[{id:"minecraft:shield",Count:1b,tag:{Enchantments:[{id:"minecraft:knockback",lvl:5}]}},{id:"minecraft:shield",Count:1b,tag:{Enchantments:[{id:"minecraft:knockback",lvl:5}]}}],HandDropChances:[0.0f,0.0f],DeathLootTable:"",Silent:1b,CustomName:'{"text":"§f§l像素模型骷髅§f的盾"}'}
