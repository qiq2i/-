...
execute if score @s qiq2i_1 matches 1 run summon item_frame ~ ~ ~ {Item:{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:custom_model_data":2002025}},Facing:1b,Invisible:1b,Fixed:1b,Invulnerable:1b,Tags:["qiq2i_clga1_rooma1.2_item_frame_1","qiq2i_clga1_rooma1.2_item_frame"]}
execute if score @s qiq2i_1 matches 1 run summon item_frame ~ ~ ~ {Item:{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:custom_model_data":2002026}},Facing:1b,Invisible:1b,Fixed:1b,Invulnerable:1b,Tags:["qiq2i_clga1_rooma1.2_item_frame_2","qiq2i_clga1_rooma1.2_item_frame"]}
