...
execute positioned ~-0.25 ~ ~-0.25 if entity @e[type=#qiq2i_clga1:friend,tag=!qiq2i_admin,dx=0.5,dy=-2,dz=0.5] run particle dust 0.565 0 0.788 5 ~ ~ ~ 1 1 1 0 20
...
execute run particle dust 0.565 0 0.788 5 ~ ~ ~ 0.25 0.25 0.25 0 2 force
