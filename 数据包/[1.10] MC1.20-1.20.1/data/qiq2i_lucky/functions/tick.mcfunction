...
execute as @e[tag=qiq2i_lucky_block.type.1,tag=!qiq2i_lucky_block.type.1_set] at @s run summon item_frame ~ ~ ~ {Item:{id:"minecraft:bat_spawn_egg",count:1,components:{"minecraft:custom_model_data": 2002022}},Facing:1b,Invisible:1b,Fixed:1b,Invulnerable:1b,Tags:["qiq2i_lucky_block.type.1_model.1"]}
